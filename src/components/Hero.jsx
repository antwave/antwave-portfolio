...
const Hero = () => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-[1200px] overflow-visible md:h-[70vh] mx-auto py-8 bg-black size-fit">
      ...
      <div className="col-span-2 px-5 my-auto">
        <h1 className="text-white text-4xl sm:text-5xl lgtext:9xl font-bold absolute md:relative">
          <TypeAnimation
            sequence={[
              "Desarrollador",
              1000,
        ...
        <p className="text-white sm:text-lg my-6 lg:text-xl lg:whitespace-nowrap mt-20 md:mt-0">
          Apasionado por la{" "}
        ...
        <div className="my-8">
          <a
            href={CV}
            download="Antonio_Carrizosa_CV.pdf"
